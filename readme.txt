...
-Implements an embedded version of BDSp2Sub to determine the number of subtitle captions for all English subtitles, and to extract all forced captions.
-Implements the MKV Merge CLI for bulk muxing.

Prerequisites
-MKVToolNix must be installed, and the paths to relevant components must be specified in the MKV Bulk Muxer options menu. MKVToolNix can be downloaded from http://www.bunkus.org/videotools/mkvtoolnix/downloads.html
